...
var __PRIVATE_WatchChangeAggregator = class {
  ...
  $e(e) {
    for (const t of e.Re)
      e.Ve && e.Ve.isFoundDocument() ? this.Ue(t, e.Ve) : this.We(t, e.key, e.Ve);
...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  dt(e, t) {
    if ("nullValue" in e)
      ...
      this.Rt(t, 15), t.Vt(__PRIVATE_normalizeNumber(e.integerValue));
      ...
      this.Rt(t, 30), t.wt(__PRIVATE_normalizeByteString(e.bytesValue)), this.yt(t);
      ...
      "mapValue" in e ? __PRIVATE_isMaxValue(e) ? this.Rt(t, Number.MAX_SAFE_INTEGER) : __PRIVATE_isVectorValue(e) ? this.bt(e.mapValue, t) : (this.Dt(e.mapValue, t), this.yt(t)) : "arrayValue" in e ? (this.vt(e.arrayValue, t), this.yt(t)) : fail();
  }
  gt(e, t) {
  ...
  qt(e) {
    for (const t of e) {
      ...
      if (e2 < 128)
        ...
        this.Lt(960 | e2 >>> 6), this.Lt(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t)
        this.Lt(480 | e2 >>> 12), this.Lt(128 | 63 & e2 >>> 6), this.Lt(128 | 63 & e2);
      else {
        const e3 = t.codePointAt(0);
  ...
  on(e) {
    ...
    if (this.tn.size > 0) {
      ...
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.an(e2, t2) || !this.un(this.nn[s++], t2))
          return false;
      }
      ++i;
    }
    for (; i < n.length; ++i) {
      const e2 = n[i];
      if (s >= this.nn.length || !this.un(this.nn[s++], e2))
        return false;
    }
    return true;
  }
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  dn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r)
        if (this.pn(t, s.fieldPath) && isArray(e2))
          r = this.yn(r, s, e2);
        else {
    ...
    if (null != i) {
      ...
      if (isArray(s))
        for (const i2 of s.arrayValue.values || [])
          n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Rn(i2), r));
    } else
...
var __PRIVATE_MemoryMutationQueue = class {
  ...
  addMutationBatch(e, t, n, r) {
    ...
    for (const t2 of r)
      this.vr = this.vr.add(new __PRIVATE_DocReference(t2.key, i)), this.indexManager.addToCollectionParentIndex(e, t2.key.path.popLast());
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 17) {
    ...
    this.Ri = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.p())
  ...
  async xi() {
    if (this.isPrimary && !this.Oi(this.Ai, 18e5)) {
      ...
      if (this.fi)
        for (const t of e)
          this.fi.removeItem(this.Li(t.clientId));
    }
  }
  /**
  ...
  Di(e) {
    ...
    return __PRIVATE_primaryClientStore(e).get("owner").next((t) => {
      if (null !== t && this.Oi(t.leaseTimestampMs, 5e3) && !this.Bi(t.ownerId)) {
        if (this.Fi(t) && this.networkEnabled)
          return true;
        if (!this.Fi(t)) {
  ...
  runTransaction(e, t, n) {
    ...
    return this.mi.runTransaction(e, r, i, (r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this.$r ? this.$r.next() : __PRIVATE_ListenSequence.oe), "readwrite-primary" === t ? this.bi(s).next((e2) => !!e2 || this.Di(s)).next((t2) => {
      if (!t2)
        throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.li.enqueueRetryable(() => this.Ri(false)), new FirestoreError(D.FAILED_PRECONDITION, C);
      return n(s);
  ...
  Ui(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => {
      if (null !== e2 && this.Oi(e2.leaseTimestampMs, 5e3) && !this.Bi(e2.ownerId) && !this.Fi(e2) && !(this.Pi || this.allowTabSynchronization && e2.allowTabSynchronization))
        throw new FirestoreError(D.FAILED_PRECONDITION, Ve);
    });
  }
  /**
...
var __PRIVATE_QueryEngine = class {
  ...
  getDocumentsMatchingQuery(e, t, n, r) {
    ...
    return this.Xi(e, t).next((e2) => {
      ...
      if (!i.result)
        return this.es(e, t, r, n).next((e2) => {
          i.result = e2;
        });
    }).next(() => {
      if (i.result)
      ...
      return this.ts(e, t, n2).next((r2) => {
        if (i.result = r2, this.Hi)
          return this.ns(e, t, n2, r2.size);
      });
    }).next(() => i.result);
  }
  ns(e, t, n, r) {
...
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  ...
  return r.persistence.runTransaction(
    ...
    (e2) => function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
      ...
      if (t2)
        return i = t2.lastLimboFreeSnapshotVersion, r.Gr.getMatchingKeysForTargetId(e2, t2.targetId).next((e3) => {
          s = e3;
        });
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    if (r.snapshotVersion.compareTo(s) >= 0)
      return i.jr.saveNamedQuery(e2, t);
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  bs(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.Cs)
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          __PRIVATE_logDebug(ge, `RPC '${e}' stream ${r} received:`, i2), P.vo(i2);
      }
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.U_.$e(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.U_.Je(t) : e.U_.Ge(t), !n.isEqual(SnapshotVersion.min()))
    try {
...
var __PRIVATE_BundleLoader = class {
  ...
  Pa(e) {
    ...
    if (e.ca.namedQuery)
      this.queries.push(e.ca.namedQuery);
      ...
      e.ca.document && (this.documents[this.documents.length - 1].document = e.ca.document, ++t);
...
async function __PRIVATE_syncEngineUnlisten(e, t, n) {
  ...
  if (s.length > 1)
    return r.Oa.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r.xa.delete(t);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const r of e.Oa.get(t))
    e.xa.delete(r), n && e.Ma.Wa(r, n);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n)
    if (r instanceof __PRIVATE_AddedLimboDocument)
      e.ka.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  za(e) {
    ...
    if (!__PRIVATE_WebStorageSharedClientState.p(t))
...
async function __PRIVATE_ensureOfflineComponents(e) {
  if (!e._offlineComponents)
    if (e._uninitializedComponentsProvider) {
      ...
      __PRIVATE_logDebug("FirestoreClient", "Using default OfflineComponentProvider"), await __PRIVATE_setOfflineComponentProvider(e, new __PRIVATE_LruGcMemoryOfflineComponentProvider(void 0));
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  Lu(e) {
    ...
    if (__PRIVATE_isWrite(this.Mu) && be.test(e))
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.Mu)
      throw 1 === e.Mu ? e.qu(`${this._methodName}() can only appear at the top level of your update data`) : e.qu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.Mu))
        throw t2.qu(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path)
        throw t2.qu(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n))
        throw t2.qu(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
              ...
              value: {
                arrayValue: {
                  values: e3.toArray().map((e4) => {
                    if ("number" != typeof e4)
                      throw t3.qu("VectorValues must only contain numeric values.");
